...
This version if the backplane is derived from David Hansel's design (https://github.com/dhansel/Altair8800-IOBus/tree/main/00-backplane) but with the difference that instead of getting powered over the bus by the Altair 8800 Mini or similar device, this backplane is locally powered by an external DC supply and generates the +5V and +3.3V supplies locally.
